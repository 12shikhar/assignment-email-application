...
public class EmailApplicationUI {
	...
	private void buildWelcomeSection() {
		...
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
		System.out.println("Welcome to Email generation @@");
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
	...
	private Employee buildEmployeeDetailsSection() {
		...
		String firstName = dc.nextLine();
		
		System.out.println("Enter employee's last name: ");
		String lastName = dc.nextLine();
	...
	private void callService(Employee employee) {
		...
		CredentialsGenerator dev = new CredentialsGenerator(employee);
		
		dev.generateEmailID();
		dev.generatePassword();
